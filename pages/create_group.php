...
<head>
    ...
    <title>Create New Group - Discussion Platform</title>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Form a new study group to collaborate with others</p>
                    </div>
                            ...
                            <p class="text-sm text-red-700">
                                ...
                                switch($_GET['error']) {
                                    ...
                                    case 'already_exists':
                                        ...
                                        break;
                                    default:
                                        echo "There was an error creating the group. Please try again.";
                                }
                                ?>
                            </p>
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="relative bg-white border border-gray-200 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-all duration-200" onclick="selectPrivacy('public')">
                            <input type="radio" id="privacy_public" name="privacy" value="public" class="absolute opacity-0" checked>
                        ...
                        <div class="relative bg-white border border-gray-200 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-all duration-200" onclick="selectPrivacy('private')">
                            <input type="radio" id="privacy_private" name="privacy" value="private" class="absolute opacity-0">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-8 w-8 text-center">
